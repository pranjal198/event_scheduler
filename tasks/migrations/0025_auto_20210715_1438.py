...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='task',
            name='date',
            field=models.DateField(default=datetime.datetime(2021, 7, 15, 9, 8, 21, 967891, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='task',
            name='remainder',
        ...
        migrations.AlterField(
            model_name='task',
            name='remainder_date',
            field=models.DateField(default=datetime.datetime(2021, 7, 15, 9, 8, 22, 20749, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='task',
            name='remainder_time',
            field=models.TimeField(default=datetime.datetime(2021, 7, 15, 9, 8, 22, 20749, tzinfo=utc)),
        ),
        migrations.AlterField(
            model_name='task',
            name='target_batch',
